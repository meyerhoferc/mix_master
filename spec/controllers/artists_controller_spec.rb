...
describe ArtistsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns requested artist as @artist and renders show template" do
      artist = create(:artist)
  ...
  describe "GET #edit" do
    it "assigns requested artist as @artist and renders the edit template" do
      artist = create(:artist)
